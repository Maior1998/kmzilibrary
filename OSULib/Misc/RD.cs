...
namespace OSULib.Misc
{
    ...
    public static class RD
    {
        ...
        ///     возрастания. Если в количесто послать 0, выдаст весь диапазон.
        /// </summary>
        /// <param name="Count">
        ///     Число генерируемых чисел. Если опускается, возвращается весь диапазон от нижней границы до верхней
        ///     включительно.
        /// </param>
