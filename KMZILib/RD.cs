...
namespace KMZILib
{
    ...
    public static class RD
    {
        ...
        /// <summary>
        /// Генерирует равномерно распределенные случайные числа в указанном размере и диапазоне. Без повторений. В порядке возрастания.
        /// </summary>
        /// <param name="Count">Число генерируемых чисел. Если опускается, возвращается весь диапазон от нижнейграницы до верхней включительно.</param>
        ...
        /// <exception cref="InvalidOperationException">Число генерируемых чисел в диапазоне не может быть больше длины самого диапазона.</exception>
